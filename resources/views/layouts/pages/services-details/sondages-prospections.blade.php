            ...
            <div class="container">
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="services-list">
                        <a href="{{ route('etude-geotechnique.details') }}"><i class="bi bi-arrow-right-circle"></i><span>Études Géotechniques</span></a>
                        ...
                        <a href="{{ route('sondages-prospections.details') }}" class="active"><i class="bi bi-arrow-right-circle"></i><span>Sondages & Prospections</span></a>
