        ...
        <div class="container-fluid">
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-0 mx-3 shadow-lg">
                        <form action="{{route('login')}}" method="POST">
                            @csrf
                            <div class="d-flex align-items-center justify-content-between mb-0">
                                <div class="login-logo">
                                    <img src="{{ asset('assets/img/logo.jpg') }}" alt="Logo ISN">
                                    <h4 class="mx-2 text-primary">Connectez Vous !!!</h4>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="remember_me"><small>Se rappler de moi</small></label>
                                </div>
