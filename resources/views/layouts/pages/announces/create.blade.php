                ...
                <div class="bg-secondary rounded h-100 p-4">
                        ...
                        <form action="{{route('announces.store')}}" method="POST" class="px-4 py-2" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                 ...
                                 <textarea  name="description"  id="description"  class="form-control @error('description') is-invalid @enderror"  rows="4" >{{ old('description', $announce->description ?? '') }}</textarea>
